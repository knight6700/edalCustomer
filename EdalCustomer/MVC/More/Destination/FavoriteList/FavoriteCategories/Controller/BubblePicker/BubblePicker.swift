...
//    }
    ...
    public func reloadData(){
        ...
        BPDynamics.resistance = 0.2

        BPCollision = UICollisionBehavior(items: nodes)
        BPCollision.setTranslatesReferenceBoundsIntoBoundary(with: UIEdgeInsets(top: 0, left: -500, bottom: -100, right: -500))
