...
class SearchServices {
    ...
    func getProviderServices(by servicesId: Int,by page: Int ,completion: @escaping (_ error: String?, _ data: SearchableResponse?) -> ()){
        ...
        let parameters:[String: Any] = ["service_id": servicesId,
                                        ...
                                        "device_type": "2"]
        let headers = RequestComponent.headerComponent([.lang , .authorization])
        RequestManager().request(fromUrl: url, byMethod: .post, withParameters: parameters, andHeaders: headers) { (error, data: SearchableResponse?) in
    ...
    func search(byKeyword search: String?, byDistrict district_id: Int? ,byDate date: String?, byTime time: String?, byPage page: Int?, byMinPrice min_price: Int?, byMaxPrice max_price: Int?,byLocationRange location_range: Int?, byCategoryId category_id: Int?, byRatingFrom rating_from: Int?, byRatingTo rating_to:Int?, bySorting sorting: Int?,locationRange: Int?, completion: @escaping (_ error: String?, _ data: SearchableResponse?) -> ()){
        ...
        ApiClient.CallApi(endPoint: .search(parameters: parameters)) { (data: SearchableResponse?, error: Error?, code) in
