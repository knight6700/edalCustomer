...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    @IBInspectable open var firstColorbetweenHandles: UIColor?
    @IBInspectable open var secondColorbetweenHandles: UIColor?
    ...
    private func setup() {
        ...
        sliderLineBetweenHandles.startPoint = CGPoint.init(x: 0.0, y: 0.0)
        sliderLineBetweenHandles.startPoint = CGPoint.init(x: 1.0, y: 1.0)
    ...
    private func updateColors() {
        ...
        if let initialColor = initialColor?.cgColor, isInitial {
            ...
            sliderLineBetweenHandles.colors = [firstColorbetweenHandles?.cgColor ?? tintCGColor , secondColorbetweenHandles?.cgColor ?? tintCGColor]
