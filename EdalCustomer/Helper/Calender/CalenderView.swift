...
struct Colors {
    static var darkGray = #colorLiteral(red: 0.968627451, green: 0.968627451, blue: 0.968627451, alpha: 1)
    static var darkRed = #colorLiteral(red: 0.3764705882, green: 0.8039215686, blue: 1, alpha: 1)
}
enum MyTheme {
    case light
    case dark
